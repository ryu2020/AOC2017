...
public class Two {
    ...
    ArrayList<ArrayList<Integer>> parseString(String str){
    ...
    public static void main(String[] AAAAAAAA){
        String str = "737\t1866\t1565\t1452\t1908\t1874\t232\t1928\t201\t241\t922\t281\t1651\t1740\t1012\t1001\n" +
        ...
        Two two = new Two();
        ArrayList<ArrayList<Integer>> arrl = two.parseString(str);
        for(ArrayList<Integer> arrr: arrl){
            System.out.println(arrr);
        }
        int total = 0;
        for(ArrayList<Integer> a: arrl){
            int z = 0;
            for(int x = 0; x < a.size(); x++){
                for(int y = 0; y < a.size(); y++){
                    if(a.get(x) % a.get(y) == 0 && x != y){
